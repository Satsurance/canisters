          ...
          <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex items-center space-x-4 mt-4 md:mt-0">
              <div class="text-right">
                ...
                <div class="text-lg font-semibold text-gray-900">{{ currentNetwork }}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="bg-white rounded-lg shadow-sm p-6 opacity-60">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-4">
                ...
                <button
                  disabled
                  class="btn-primary px-4 py-2 rounded-lg opacity-50 cursor-not-allowed w-full"
                >
                  Collect Rewards
                </button>
              </div>
              ...
              <div class="space-y-4">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <input
                    ...
                    max="10"
                    step="0.1"
                    class="form-input w-20 opacity-50 cursor-not-allowed"
                    placeholder="10"
                    disabled
                  />
                  <button
                    disabled
                    class="btn-primary px-4 py-2 rounded-lg opacity-50 cursor-not-allowed"
                  >
                    Update
                  </button>
                </div>
                ...
                <div class="flex-1">
                  ...
                  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <span class="font-medium text-gray-900 ml-1">{{ (Number(product.annual_percent) / 100).toFixed(2) }}%</span>
                    </div>
                    <div>
                      <span class="text-gray-500">Max Duration:</span>
                      <span class="font-medium text-gray-900 ml-1">{{ formatDuration(product.max_coverage_duration) }}</span>
                    </div>
                    <div>
                      <span class="text-gray-500">Pool Allocation:</span>
                      <span class="font-medium text-gray-900 ml-1">{{ (Number(product.max_pool_allocation_percent) / 100).toFixed(2) }}%</span>
                    </div>
                    <div>
